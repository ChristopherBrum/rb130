...
# list << todo1                   # shovels todo1 to end of list, returns list
# list << todo2                   # shovels todo2 to end of list, returns list
# list << todo3                   # shovels todo3 to end of list, returns list
